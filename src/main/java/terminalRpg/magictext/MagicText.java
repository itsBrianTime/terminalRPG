...
public class MagicText {
    ...
    public static final int BACKGROUNDBRIGHT = 3;    
    ...
    // formatting arrays
    private static final String[] BlACK_TEXT = {"\u001b[30m", "\u001b[30;1m", 
        "\u001b[40m", "\u001b[40;1m"};

    private static final String[] RED_TEXT = {"\u001b[31m", "\u001b[31;1m", 
        "\u001b[41m", "\u001b[41;1m"};

    private static final String[] GREEN_TEXT = {"\u001b[32m", "\u001b[32;1m", 
        "\u001b[42m", "\u001b[42;1m"};

    private static final String[] YELLOW_TEXT = {"\u001b[33m", "\u001b[33;1m", 
        "\u001b[43m", "\u001b[43;1m"};

    private static final String[] BLUE_TEXT = {"\u001b[34m", "\u001b[34;1m", 
        "\u001b[44m", "\u001b[44;1m"};
    
    private static final String[] PURPLE_TEXT = {"\u001b[35m", "\u001b[35;1m", 
        "\u001b[45m", "\u001b[45;1m"};

    private static final String[] CYAN_TEXT = {"\u001b[36m", "\u001b[36;1m", 
        "\u001b[46m", "\u001b[46;1m"};

    private static final String[] WHITE_TEXT = {"\u001b[37m", "\u001b[37;1m", 
        "\u001b[47m", "\u001b[47;1m"};   
    
    private static final String[] RAINBOW_TEXT = {"\u001b[31;1m", "\u001b[33;1m", 
     ...
     */
    public static boolean drawColoredText(String text, String color, int format, 
     ...
     * @param format int that represents the text formatting desired
     */
    public static String getColoredText(String text, String color, int format,
        boolean bold, boolean underlined, boolean reversed) {
     ...
     */
    public static boolean resetLines(int lines) {
     ...
     */
    public static boolean cursorUp(int numLines) {
     ...
     * @param numLines lines to move
     */
    public static boolean cursorDown(int numLines) {
     ...
     */
    public static boolean cursorRight(int numSpaces) {
     ...
     * @param numSpaces spaces to move
     */
    public static boolean cursorLeft(int numSpaces) {
     ...
     */
    public static boolean nextLine(int numLines) {
     ...
     */
    public static boolean previousLine(int numLines) {
     ...
     */
    public static boolean setCursorPosition(int row, int col) {
     ...
     */
    public static boolean clearScreen(int cursorLocation) {
     ...
     */
    public static boolean clearLine(int clearFrom) {
     ...
     */
    public static boolean saveCursorPosition() {
        System.out.print("\u001b[s");
        return true;
    }
     ...
     */
    public static boolean loadCursorPosition() {
        System.out.print("\u001b[u");
        return true;
    }
    
    private static String colorPicker(String color, int format, String text) {
        switch (color) {
            case BLACK:
    ...
    private static String rainbowColor(String text) {
    ...
    private static String stylePicker(boolean bold, boolean underlined, boolean reversed) {
        String addedStyle = "";
        if (bold) {
            addedStyle += BOLD;
        }
